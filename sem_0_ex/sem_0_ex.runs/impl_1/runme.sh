...
HD_PWD='c:/Users/j48s677/Desktop/vivado_stuff/SEM/SEM/sem_0_ex/sem_0_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sem_0_sem_example.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sem_0_sem_example.tcl -notrace
