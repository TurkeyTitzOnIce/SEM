...
HD_PWD='c:/Users/j48s677/Desktop/vivado_stuff/SEM/SEM/sem_0_ex/sem_0_ex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sem_0_sem_example.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sem_0_sem_example.tcl
